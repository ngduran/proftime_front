...
class InstituicaoInput extends BaseInput {
    constructor() {
        super(); 
    }
    ...
    render() {
        ...
        const data_translate_ph      = this.getAttribute('data-translate_ph') || '';
        ...
        this.shadowRoot.innerHTML = `
            ...
            <div class="input-group">
                <input type="text" id="${id}" name="${name}" data-translate="${data_translate_ph}" placeholder="${placeholder}" ${isRequired}>
...
customElements.define('instituicao-input', InstituicaoInput);